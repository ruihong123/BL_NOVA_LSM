...
std::atomic_int_fast32_t leveldb::EnvBGThread::bg_flush_memtable_thread_id_seq = std::atomic_int_fast32_t(0);
std::atomic_int_fast32_t leveldb::EnvBGThread::bg_compaction_thread_id_seq = atomic_int_fast32_t(0);
